...
class IndexController extends Controller{
    ...
    function _initialize()
    {
        ...
        $menu_list['left'][]=array( 'title' => L('_HOME_PAGE_'), 'href' => U('Book/Index/index'),'tab'=>'home');
        foreach ($tree as $category) {
            $menu = array('tab' => 'category_' . $category['id'], 'title' => $category['title'], 'href' => U('Book/index/bookList', array('category' => $category['id'])));
            if ($category['_']) {
                $menu['children'][] = array( 'title' => L('_ALL_'), 'href' => U('Book/index/bookList', array('category' => $category['id'])));
                foreach ($category['_'] as $child)
                    $menu['children'][] = array( 'title' => $child['title'], 'href' => U('Book/index/bookList', array('category' => $child['id'])));
            }
            $menu_list['left'][] = $menu;
        }
